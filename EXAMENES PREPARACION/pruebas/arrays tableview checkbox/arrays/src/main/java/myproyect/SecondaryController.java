...
public class SecondaryController {
    ...
    @FXML TextField tfEdad;
    @FXML TextField tfDni;

    @FXML VBox vbox;
        // 2- observablelist<Clase.java>
    @FXML private ObservableList<User> listaObservable; 
/*     @FXML private ObservableList<User> listaObservable2;  */  
    ...
    private void nuevoUsuario(){
        ...
        lista.add(new User(tfNombre.getText(), tfApellido.getText(), edad, tfDni.getText()));

        listaObservable = FXCollections.observableArrayList();
        listaObservable.addAll(lista);
